...
bool Shader::loadFromSource(const char* source, const unsigned int& type) {
...
void Shader::setUniformVec2(const char* uniform_name, glm::vec2 load_uniform) const noexcept {
...
void Shader::setUniformVec3(const char* uniform_name, glm::vec3 load_uniform) const noexcept {
...
void Shader::setUniformVec4(const char* uniform_name, glm::vec4 load_uniform) const noexcept {
...
void Shader::setUniformMat3(const char* uniform_name, glm::mat3 load_uniform) const noexcept {
...
void Shader::setUniformMat4(const char* uniform_name, glm::mat4 load_uniform) const noexcept {
...
void Shader::setUniformInt(unsigned int shaderRef, const char* uniform_name, int load_uniform) noexcept {
    glUniform1i(glGetUniformLocation(shaderRef, uniform_name), load_uniform);
}
void Shader::setUniformIntArray(unsigned int shaderRef, const char* uniform_name, int* load_uniform, unsigned int count) noexcept {
    glUniform1iv(glGetUniformLocation(shaderRef, uniform_name), count, load_uniform);
}

void Shader::setUniformFloat(unsigned int shaderRef, const char* uniform_name, float load_uniform) noexcept {
    glUniform1f(glGetUniformLocation(shaderRef, uniform_name), load_uniform);
}
void Shader::setUniformFloatArray(unsigned int shaderRef, const char* uniform_name, float* load_uniform, unsigned int count) noexcept {
    glUniform1fv(glGetUniformLocation(shaderRef, uniform_name), count, load_uniform);
}

void Shader::setUniformVec2(unsigned int shaderRef, const char* uniform_name, const glm::vec2& load_uniform) noexcept {
    glUniform2f(glGetUniformLocation(shaderRef, uniform_name), load_uniform.x, load_uniform.y);
}
void Shader::setUniformVec2Array(unsigned int shaderRef, const char* uniform_name, glm::vec2* load_uniform, unsigned int count) noexcept {
    glUniform2fv(glGetUniformLocation(shaderRef, uniform_name), count, &load_uniform[0].x);
}

void Shader::setUniformVec3(unsigned int shaderRef, const char* uniform_name, const glm::vec3& load_uniform) noexcept {
    glUniform3f(glGetUniformLocation(shaderRef, uniform_name), load_uniform.x, load_uniform.y, load_uniform.z);
}
void Shader::setUniformVec3Array(unsigned int shaderRef, const char* uniform_name, glm::vec3* load_uniform, unsigned int count) noexcept {
    glUniform3fv(glGetUniformLocation(shaderRef, uniform_name), count, &load_uniform[0].x);
}

void Shader::setUniformVec4(unsigned int shaderRef, const char* uniform_name, const glm::vec4& load_uniform) noexcept {
    glUniform4f(glGetUniformLocation(shaderRef, uniform_name), load_uniform.x, load_uniform.y, load_uniform.z, load_uniform.w);
}
void Shader::setUniformVec4Array(unsigned int shaderRef, const char* uniform_name, glm::vec4* load_uniform, unsigned int count) noexcept {
    glUniform4fv(glGetUniformLocation(shaderRef, uniform_name), count, &load_uniform[0].x);
}

void Shader::setUniformMat3(unsigned int shaderRef, const char* uniform_name, const glm::mat3& load_uniform) noexcept {
    glUniformMatrix3fv(glGetUniformLocation(shaderRef, uniform_name), 1, GL_FALSE, glm::value_ptr(load_uniform));
}
void Shader::setUniformMat3Array(unsigned int shaderRef, const char* uniform_name, glm::mat3* load_uniform, unsigned int count) noexcept {
    glUniformMatrix3fv(glGetUniformLocation(shaderRef, uniform_name), count, GL_FALSE, glm::value_ptr(load_uniform[0]));
}

void Shader::setUniformMat4(unsigned int shaderRef, const char* uniform_name, const glm::mat4& load_uniform) noexcept {
    glUniformMatrix4fv(glGetUniformLocation(shaderRef, uniform_name), 1, GL_FALSE, glm::value_ptr(load_uniform));
}
void Shader::setUniformMat4Array(unsigned int shaderRef, const char* uniform_name, glm::mat4* load_uniform, unsigned int count) noexcept {
    glUniformMatrix4fv(glGetUniformLocation(shaderRef, uniform_name), count, GL_FALSE, glm::value_ptr(load_uniform[0]));
}
